...
if __name__ == '__main__':
    ...
    # model.load_state_dict(checkpoint['net_state_dict'])
    checkpoint=torch.load('/data/face_recognition/Mobilefacenet/saving_Faces_emore_ckpt_arcface_64_randombrightness/Iter_125000_model.ckpt')
    # /data/face_recognition/Mobilefacenet/saving_Faces_emore_ckpt/Iter_410000_margin.ckpt
    model.load_state_dict(checkpoint['net_state_dict'])
    margin.load_state_dict(torch.load('/data/face_recognition/Mobilefacenet/saving_Faces_emore_ckpt_arcface_64_randombrightness/Iter_125000_margin.ckpt')['net_state_dict'])
    ...
    criterion = CrossEntropyLabelSmooth(85742, 0.1).to(device)
