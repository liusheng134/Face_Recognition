...
if __name__ == '__main__':
    ...
    parser.add_argument('--rec', type=str, default='E:\\InsightFace_Pytorch-master\\data\\faces_emore', help='bin file path')
    parser.add_argument('--save_rec', type=str, default='E:\\faces_emore_images', help='save file path within rec path')
