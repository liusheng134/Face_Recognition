...
parser.add_argument('--root', type=str, default='/data/zwh/00.PaperRecurrence/2.InsightFace_Pytorch/2.Dataset/faces_emore/imgs', help='image data folder path')
parser.add_argument('--file', type=str, default='/data/zwh/00.PaperRecurrence/2.InsightFace_Pytorch/2.Dataset/faces_emore/imgs/faces_emore_align_112.txt', help='anno file path')
