...
def load_data(batch_size, dataset = 'Faces_emore'):
    ...
    dataloaders = {'train': DataLoaderX(dataset_train, batch_size=batch_size, shuffle=True, num_workers=8),
                   'LFW': DataLoaderX(dataset_LFW, batch_size=batch_size, shuffle=False, num_workers=4),
                   'CFP_FP': DataLoaderX(dataset_CFP_FP, batch_size=batch_size, shuffle=False, num_workers=4),
                   'AgeDB30': DataLoaderX(dataset_AgeDB30, batch_size=batch_size, shuffle=False, num_workers=4)}
...
if __name__ == '__main__':
    ...
    from sknet_face import SKNet
    model = SKNet(None, [3, 4, 23, 3]).to(device)
