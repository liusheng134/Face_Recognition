...
from load_dataset import load_data,load_data_dataparallel
...
# 加载数据
data_loaders , dataset_sizes, dataset = load_data_dataparallel(args.batch_size)
...
def main():
    ...
    if resume:
        ...
        checkpoint1 = torch.load('margin.pt')
