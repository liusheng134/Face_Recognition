...
parser.add_argument('--save', type=str, default='./checkpoints_ms1m_arcface/', help='experiment name')
...
parser.add_argument('--begin', type=int, default=50, help='batch size')
...
def main():
    ...
    if MULTI_GPU:
        optimizer = torch.optim.SGD(
            ...
            [{'params': margin.module.parameters(), 'weight_decay': args.weight_decay}],
            args.learning_rate,
    ...
    for epoch in range(args.epochs):
        ...
        # training
        train_acc, train_obj = train(data_loaders['train_subset'], data_loaders['valid_subset'], model,margin, optimizer, optimizer_a, criterion, lr,epoch)
...
def train(train_queue, valid_queue, model, margin, optimizer, optimizer_a, criterion, lr,epoch):
    ...
    for step, (input, target) in enumerate(train_queue):
        ...
        try:
            ...
            input_search, target_search = next(valid_queue_iter)
        input_search = input_search.cuda(non_blocking=True).half()
